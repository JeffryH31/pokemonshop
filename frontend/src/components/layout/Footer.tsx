      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        <div className="grid grid-cols-2 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link to="/about" className="text-sm text-[#5a5550] hover:text-[#a09a8e] transition-colors">
                  Tentang Kami
                </Link>
              </li>
        ...
        <div className="border-t border-[#1e1e2a] mt-8 pt-6 flex flex-col sm:flex-row items-center justify-between gap-3">
          <p className="text-xs text-[#5a5550]">© {new Date().getFullYear()} Wonderplays. Hak cipta dilindungi.</p>
          <p className="text-xs text-[#5a5550]">Pokémon adalah merek dagang Nintendo / Creatures Inc. / GAME FREAK inc. Wonderplays tidak berafiliasi dengan perusahaan apapun.</p>
        </div>
      </div>
    </footer>
  )
