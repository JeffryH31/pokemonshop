      ...
      <div className="mt-6 relative">
        ...
        {isLoading ? (
          ...
          <div className="flex flex-col items-center justify-center py-24 text-center">
            ...
            <p className="text-sm text-[#a09a8e] mt-1">Periksa koneksimu lalu coba lagi</p>
                  ...
                  {Array.from({ length: Math.min(data.last_page, 7) }, (_, i) => {
                    ...
                    if (data.last_page > 7) {
                      if (page > 3 && page < data.last_page - 2 && Math.abs(page - current) > 1) {
                        if (page === 4) return <span key={page} className="text-[#a09a8e] px-1">…</span>
                        return null
                      }
                    }
                    return (
          ...
          <div className="flex flex-col items-center justify-center py-24 text-center">
            <div className="w-16 h-16 rounded-full bg-[#1c1c28] flex items-center justify-center mb-4">
              <Layers size={24} className="text-[#a09a8e]" />
            </div>
            <p className="text-[#a09a8e] font-medium">Produk tidak ditemukan</p>
            <p className="text-sm text-[#a09a8e] mt-1">Coba ubah filter pencarian kamu</p>
            <Button
              variant="ghost"
              className="mt-4"
