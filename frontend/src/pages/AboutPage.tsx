    ...
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      ...
      >
        ...
        <div className="space-y-3 text-sm text-[#a09a8e] leading-relaxed">
          ...
          <p className="text-[#5a5550] text-xs italic">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
          {VALUES.map((v) => (
            <div key={v.title} className="bg-[#16161f] border border-[#2a2a38] hover:border-[#e5b13a33] rounded-xl p-5 transition-colors">
              ...
              <p className="text-xs text-[#5a5550] leading-relaxed">{v.desc}</p>
            </div>
          ))}
        </div>
      </motion.div>
          ...
          {MILESTONES.map((m, i) => (
            ...
            >
              ...
              <div>
                ...
                <p className="text-xs text-[#5a5550] leading-relaxed">{m.desc}</p>
              </div>
            </motion.div>
          ))}
        </div>
      ...
      >
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
          ...
          >
            ...
            <div>
              <p className="text-xs text-[#5a5550]">WhatsApp</p>
          ...
          >
            ...
            <div>
              <p className="text-xs text-[#5a5550]">Instagram</p>
          ...
          >
            ...
            <div>
              <p className="text-xs text-[#5a5550]">TikTok</p>
      ...
      >
        <p className="text-[#5a5550] text-sm mb-4">Siap mulai koleksimu?</p>
